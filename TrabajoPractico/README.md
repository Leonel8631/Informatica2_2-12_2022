...
![./recursos/fsmgenerica.png](https://github.com/DamRCorba/Informatica2_2_11_2022/blob/master/TrabajoPractico/recursos/fsmgenerica.png)
...
- Elección del sistema a modelar. __Fecha de entrega: 05/09__
> Tema a elección del alumno.

- Diagrama de máquina de estado y memoria descriptiva: __Fecha de entrega 19/09__
> La memoria descriptiva, es la explicación textual y teórica del funcionamiento del sistema.

- Primer versión de código: __Fecha de entrega 17/10__
> Resolución de la mecánica de la máquina de estado sin funciones especificas.

- Código final: __Fecha de entrega 21/11__
> Código Final.
